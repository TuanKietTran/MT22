...
class ParserSuite(unittest.TestCase):
    ...
    def test_string_expr_success(self):
        """"""
        input = """main: function void () {str="abc"::("def"::("ghi"::"jkl"));}"""
        expect = """successful"""
    ...
    def test_error_not_higher_sign(self):
        """"""
        testcase = """n:integer=-!3;"""
        expect = """Error on line 1 col 11: !"""
        self.assertTrue(TestParser.test(testcase, expect, 289))

    def test_exp_sign_higher_not(self):
        """"""
        testcase = """n:integer=!-3;"""
        expect = """successful"""
    ...
    def test_wrong_functype(self):
        """"""
        testcase = """foo:function boole(var_a:integer,var_b:integer){return a<b;}"""
        expect = """Error on line 1 col 13: boole"""
    ...
    def test_keyword_func_decl(self):
        testcase = """boolean:function boolean(var_a:integer,var_b:integer){return a<b;} main: function void() {}"""
    ...
    def test_multi_declare(self):
        testcase = """inte:integer;check:function boolean(var_a:integer,var_b:integer){return a<b;} main: function void() {}"""
        expect = """successful"""
